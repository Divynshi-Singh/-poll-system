...
//     const emailValidationError = validateLogin({
//       ...formData,
//       email: emailValue,
//     }).email;
...
//     const passwordValidationError = validateLogin({
//       ...formData,
//       password: passwordValue,
//     }).password;
...
const LoginPage = () => {
  ...
  const handleChange = (e) => {
    ...
    setFormState((prevState) => {
      ...
      // Validate the respective field when it's changed
      if (name === "email") {
        updatedState.emailError = validateLogin(updatedState).email;
      }
      if (name === "password") {
        updatedState.passwordError = validateLogin(updatedState).password;
      }
  ...
  const togglePasswordVisibility = () => {
    setFormState((prevState) => ({
      ...
      passwordIconColor: prevState.isPasswordVisible ? "#7f8b96" : "#19b7ea",
    }));
  };
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={handleChange} // Using the new handleChange function
                  placeholder="name@email.com"
                  className={`w-full h-[44px] font-sans border bg-[#e8eaee] shadow-inner px-[20px] py-[10px] text-[17px] leading-[24px] font-medium rounded-[7px] text-[#374756] focus:outline-none ${formState.emailError
                      ? "border-red-500 focus:ring-0"
                      : "border-transparent focus:ring-1 focus:ring-[#19b7ea]"}`
                  }
                />
              ...
              <div className="mb-4 relative">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange} // Using the new handleChange function
                    placeholder="Password"
                    className={`w-full h-[44px] border bg-[#e8eaee] shadow-inner px-[20px] py-[10px] text-[17px] leading-[24px] font-medium rounded-[7px] text-[#374756] focus:outline-none ${formState.passwordError
                        ? "border-red-500 focus:ring-0"
                        : "border-transparent focus:ring-1 focus:ring-[#19b7ea]"}`  
                    }
                  />
                  ...
                  >
                    <FaEye
                      size={22}
                      className="text-[#7f8b96]"
                      style={{ color: formState.passwordIconColor }}
                    />
                  </button>
                </div>
