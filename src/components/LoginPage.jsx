...
const LoginPage = () => {
  ...
  return (
    <div className="flex justify-center min-h-screen">
      <div className="w-full max-w-[480px] relative mt-[-20px] sm:w-[100%] sm:px-4 lg:w-[480px]" style={{ filter: "drop-shadow(0px 4px 20px rgba(55, 71, 86, .15))" }}>
        ...
        <div className="bg-[white] pl-[40px] pr-[40px] rounded-lg shadow-lg relative z-10">
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="email" className="block text-sm text-[#5a6978] font-medium mb-[10px] pt-[40px] text-[15px] leading-[22px]">
                Email Address:
              </label>
              <input
                type="email"
                ...
                className={`w-full h-[44px] border border-transparent bg-[#e8eaee] shadow-inner px-[20px] py-[10px] text-[17px] leading-[24px] font-medium rounded-[7px] text-[#374756] focus:outline-none focus:ring-2 focus:ring-[#19b7ea] ${emailError ? 'border-red-500' : ''}`}
              />
              {emailError && <p className="text-red-500 text-sm">{emailError}</p>} 
            </div>
            <div className="mb-4 relative"> 
              <label htmlFor="password" className="block text-sm text-[#5a6978] font-medium mb-[10px] mt-[20px]">
                Password:
              </label>
              <input
                ...
                className={`w-full h-[44px] border border-transparent bg-[#e8eaee] shadow-inner px-[20px] py-[10px] text-[17px] leading-[24px] font-medium rounded-[7px] text-[#374756] focus:outline-none focus:ring-2 focus:ring-[#19b7ea] ${passwordError ? 'border-red-500' : ''}`}
              />
              ...
              >
                {passwordVisible ? <FaEyeSlash size={20} className="text-[#374756]" /> : <FaEye size={20} className="text-[#374756]" />}
              </button>
            </div>
            <div className="mb-6 text-center mb-[15px] mt-[20px]">
              <Link to="" className="text-sm no-underline text-[#5a6978] text-[14px] text-[600]">Forgot Password?</Link>
            </div>
            <div className="box-border w-[300px] h-[74px] p-0 m-0 border border-solid rounded-[4px] border-[#e0e0e0] bg-[#fafafa] cursor-pointer block mb-[7px]">
              <div className="flex items-center justify-between">
                <input
                  ...
                  checked={isHuman}
                />
                <label htmlFor="captcha" className="text-sm text-[#374756] pr-30 pt-4">I am human</label>
                <img src={hCaptchaImg} className="h-[30px]" />
              </div>
            </div>
            <button
              type="submit"
